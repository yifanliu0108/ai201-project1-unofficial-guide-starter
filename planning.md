...
I chose unofficial course-planning knowledge for UC San Diego data science students.
The scope is the stuff I would want while planning DSC quarters: lower-division order,
workload pairing, upper-division bottlenecks, EASy/prerequisite risk, and technical
elective choices.

The official pages are necessary, but they do not fully answer the student version of
the problem: "What should I take first?", "Which class unlocks the rest of my plan?",
"Can I rely on a prerequisite exception?", and "What should I review before a hard DSC
class?" That practical layer is split across the catalog, course listings, course
sites, r/UCSD threads, and peer planning notes.
...
| 12 | `documents/12_ucsd_dsc_four_year_strategy.txt` | My UCSD DSC planning notes compiled from catalog, course listings, and r/UCSD advice |
